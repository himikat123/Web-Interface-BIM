...
export default () => {
    ...
    return (
        <div ref={wrapperRef} className="relative ml-3">
            ...
            <div className={"absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none menu-user-dropdown" + (menuUserOpen ? "" : " hide")}
              role="menu" 
