...
// TODO анимация при изменениях ФС
// TODO отображать потерю связи с вебсокет
// TODO статус дисплея вкл. выкл.
// TODO 2 канала thingspeak
// TODO +датчик ветра
// TODO +батарейное питание bim8266
// TODO отправлять в веб что пришло с беспров. датчиков, в сыром виде
// TODO проверить DHT22 в ESP8266
// TODO слишком влажно сухо в esp8266
// TODO часы с ds3231 отстают на 5-20 секунд когда входишь в веб-интерфейс
// TODO свежепрошитый девайс выключает дисплей в 23.00
// TODO предпочитать сеть с лучшим сигналом при подключении
// TODO +на iphone установка времени съезжает вниз
// TODO +ограничить количество запросов от слайдера
// TODO +пересмотреть диапазон коррекции датчиков
// TODO прием по MQTT
// TODO на экранчике на английском We образается
// TODO кнопка будильника срабатывает со 2 раза
// TODO при включении, если не подключается к сети переходить в AP mode
// TODO 2 BME280
// TODO +коррекция в мм
// TODO Дату крупным шрифтом если нет значка батарейки
// TODO +сохраненный конфиг с версией
// TODO +сохраненный конфиг с любым именем файла
// TODO кнопка "отобразить порядок разрядов" для 7-сегментного