...
export default function Numitron(props: iNumitron) {
    ...
    return <svg height="200" viewBox="0 0 116 412" fill="none" className="mx-1">
        ...
        <circle cx="28.5" cy="248.5" r="2.5" fill="#555"/>
        <circle cx="87.5" cy="248.5" r="2.5" fill="#555"/>
        ...
        <circle cx="21.5" cy="123.5" r="2.5" fill="#555"/>
        <circle cx="60.5" cy="292.5" r="2.5" fill="#555"/>
        <circle cx="87.5" cy="272.5" r="2.5" fill="#555"/>
        <circle cx="87.5" cy="292.5" r="2.5" fill="#555"/>
        <circle cx="94.5" cy="253.5" r="2.5" fill="#555"/>
        <circle cx="21.5" cy="253.5" r="2.5" fill="#555"/>
        <circle cx="87.5" cy="183.5" r="2.5" fill="#555"/>
        <circle cx="28.5" cy="183.5" r="2.5" fill="#555"/>
        <circle cx="87.5" cy="128.5" r="2.5" fill="#555"/>
        <circle cx="28.5" cy="128.5" r="2.5" fill="#555"/>
        <circle cx="94.5" cy="188.5" r="2.5" fill="#555"/>
        <circle cx="94.5" cy="123.5" r="2.5" fill="#555"/>
        <circle cx="21.5" cy="188.5" r="2.5" fill="#555"/>
        <rect x="87" y="273" width="1" height="19" fill="#333"/>
        <rect x="86.2902" y="272" width="1" height="31.8602" transform="rotate(52.5408 86.2902 272)" fill="#333"/>
        <rect x="29" y="128" width="58" height="1" fill="#333"/>
        <rect x="29" y="183" width="58" height="1" fill="#333"/>
        <rect x="21" y="124" width="1" height="64" fill="#333"/>
        <rect x="94" y="189" width="1" height="64" fill="#333"/>
        <rect x="21" y="189" width="1" height="65" fill="#333"/>
        <rect x="94" y="124" width="1" height="64" fill="#333"/>
        <rect x="26" y="300" width="2" height="39" fill="#DDD"/>
        <rect x="57" y="300" width="2" height="39" fill="#DDD"/>
        <rect x="87" y="300" width="2" height="39" fill="#DDD"/>
        <rect x="70" y="300" width="2" height="39" fill="#DDD"/>
        <rect x="44" y="300" width="2" height="39" fill="#DDD"/>
