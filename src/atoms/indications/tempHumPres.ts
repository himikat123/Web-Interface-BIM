import { iSensorTHPconfig } from "../../redux/configTypes";
import { iSensorTHPdata } from "../../redux/dataTypes";
import * as vl from "../validateValues";
import * as calculate from "../calculate";
import { PresLocale } from "./hPaMM";

export default function tempHumPres(conf: iSensorTHPconfig, data: iSensorTHPdata) {
    ...
    return {
        ...
        pres: vl.validatePressureHPA(data.pres) ? PresLocale(data.pres, conf.p) : '--',
