import { iSensorTHPIconfig } from "../../redux/configTypes";
import { iSensorTHPIdata } from "../../redux/dataTypes";
import * as vl from "../validateValues";
import * as calculate from "../calculate";
import { PresLocale } from "./hPaMM";

export default function tempHumPresIaq(conf: iSensorTHPIconfig | undefined, data: iSensorTHPIdata | undefined) {
    ...
    return {
        ...
        pres: vl.validatePressureHPA(pres) ? PresLocale(pres, conf?.p ?? 0) : '--',
