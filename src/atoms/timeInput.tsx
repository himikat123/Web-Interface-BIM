...
export default function TimeInput(props: iTimeInput) {
    return <div className="group relative h-14 w-full rounded-md border focus-within:border-primary focus-within:ring-2 border-menu_light dark:border-menu_dark">
        ...
        <input className="z-10 h-full w-full rounded-md px-3.5 outline-none bg-card_light dark:bg-card_dark text-text_light dark:text-text_dark" 
            type="time"
            step={props.step}
            value={props.value ?? 0}
